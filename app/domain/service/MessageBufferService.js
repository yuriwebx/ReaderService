define([
  ...
  'Context'
   ...
   ngModule.run(['swMessageBufferService', function(swMessageBufferService)
   {
      logger.trace('run');
      swMessageBuffer.setImpl(swMessageBufferService);
   }]);

   ////////////////////////////////////////////////////////////////////////////

   ngModule.service('swMessageBufferService',
           ['$window', 'swHttp', 'swUserService',
   function( $window,   swHttp, swUserService)
   {
      ...
      this.push = function(message)
      {
         ...
         message.runId = swUserService.getRunId()||'';
